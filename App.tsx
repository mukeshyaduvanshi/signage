...
function App({ children }: PropsWithChildren) {
    ...
    useEffect(() => {
        ...
        window.localStorage.getItem('userId') == null && window.location.pathname == '/auth/cover-register'
            ? null
            : window.localStorage.getItem('userId') !== null && window.location.pathname == '/auth/cover-register'
            ? router.push('/')
            : window.localStorage.getItem('userId') == null && window.location.pathname == '/auth/cover-login'
            ? null
            : window.localStorage.getItem('userId') !== null && window.location.pathname == '/auth/cover-login'
            ? router.push('/')
