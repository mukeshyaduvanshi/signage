...
const Header = () => {
    // declared a state to save the user data
    const [userData, setUserData] = useState<any>({ data: { loggedInUser: { name: '' } } });
    ...
    /**
     * Fetches the logged-in user's data from the server and updates the userData state.
     * Sends the userId in the request body to the '/api/userdata' endpoint.
     */
    ...
    /**
     * Removes the userId from local storage and refreshes the page to logout the user. and because the userId is removed from the local storage, the user will be redirected to login page automatically.
     */
    const handleLogout = () => {
            ...
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between lg:hidden ltr:mr-2 rtl:ml-2">
                        <Link href="/" className="main-logo flex shrink-0 items-center text-[20px] font-bold">
                            {/* <img className="ml-[5px] w-32 md:w-44" src="/assets/images/logo.svg" alt="logo" /> */}
                            SAWHNEY SIGNAGE
                        </Link>
                        <button
                            type="button"
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    {userData.data.loggedInUser ? userData.data.loggedInUser.name : null}
                                                    <span className="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">Pro</span>
                                                </h4>
                                                <button type="button" className="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">
                                                    {userData.data.loggedInUser ? userData.data.loggedInUser.email : null}
                                                </button>
                                            </div>
                                        </div>
                                    </li>
